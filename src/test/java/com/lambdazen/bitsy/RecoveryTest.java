...
public class RecoveryTest extends FileBasedTestCase {
    ...
    public void testPartialTx() throws Exception {
        for (long minSizeForParallelLoader : new long[] {10, 1024 * 1024}) {
            ...
            String[] fileNames = new String[] {"txA.txt", "txB.txt", "vA.txt", "vB.txt", "eA.txt", "eB.txt", "metaA.txt", "metaB.txt"};
            ...
            for (int i=0; i < paths.length; i++) {
                ...
                for (String fileName : fileNames) {
                    Files.copy(sourceDir.resolve(fileName), targetDir.resolve(fileName), StandardCopyOption.REPLACE_EXISTING);
                }
