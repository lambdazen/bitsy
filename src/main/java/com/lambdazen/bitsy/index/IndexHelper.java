...
public class IndexHelper {
    public static <T extends BitsyElement> Collection<T> filterElementsByKeyValue(Collection<T> elems, String key, Object value) {
    ...
    public static Collection<VertexBean> filterVertexBeansByKeyValue(Collection<VertexBean> elems, String key, Object value) {
        ArrayList<VertexBean> ans = new ArrayList<VertexBean>();
        
        for (VertexBean elem : elems) {
            Object elemVal = (elem.getProperties() == null) ? null : (elem.getProperties().get(key)); 
    ...
    public static Collection<EdgeBean> filterEdgeBeansByKeyValue(Collection<EdgeBean> elems, String key, Object value) {
        ...
        for (EdgeBean elem : elems) {
            Object elemVal = (elem.getPropertiesDict() == null) ? null : (elem.getPropertiesDict().getProperty(key)); 
